...
CREATE TABLE City (
    ...
    population        int(64) unsigned    NOT NULL, 
...
CREATE TABLE Transaction (
    ...
    sold_quantity       int(64)             NOT NULL        DEFAULT 0, 
...
ALTER TABLE ProductHasCategory
    ...
    ADD CONSTRAINT fk_ProductHasCategory_category_name_Category_name    FOREIGN KEY (category_name) REFERENCES Category (name); 
